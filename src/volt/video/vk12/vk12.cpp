...
std::map<video::resource_type, VmaMemoryUsage> vma_memory_usages{
	{ video::resource_type::internal, VMA_MEMORY_USAGE_GPU_ONLY },
	{ video::resource_type::staging,  VMA_MEMORY_USAGE_CPU_ONLY },
	{ video::resource_type::write,    VMA_MEMORY_USAGE_CPU_TO_GPU },
	{ video::resource_type::read,     VMA_MEMORY_USAGE_GPU_TO_CPU }
};

std::map<video::texture_format, VkFormat> texture_formats{
	{ video::texture_format::r8,    VK_FORMAT_R8_UNORM },
	{ video::texture_format::rg8,   VK_FORMAT_R8G8_UNORM },
	{ video::texture_format::rgb8,  VK_FORMAT_R8G8B8_UNORM },
	{ video::texture_format::rgba8, VK_FORMAT_R8G8B8A8_UNORM },

	{ video::texture_format::r16,    VK_FORMAT_R16_UNORM },
	{ video::texture_format::rg16,   VK_FORMAT_R16G16_UNORM },
	{ video::texture_format::rgb16,  VK_FORMAT_R16G16B16_UNORM },
	{ video::texture_format::rgba16, VK_FORMAT_R16G16B16A16_UNORM },

	{ video::texture_format::r16f,    VK_FORMAT_R16_SFLOAT },
	{ video::texture_format::rg16f,   VK_FORMAT_R16G16_SFLOAT },
	{ video::texture_format::rgb16f,  VK_FORMAT_R16G16B16_SFLOAT },
	{ video::texture_format::rgba16f, VK_FORMAT_R16G16B16A16_SFLOAT },

	{ video::texture_format::r32f,    VK_FORMAT_R32_SFLOAT },
	{ video::texture_format::rg32f,   VK_FORMAT_R32G32_SFLOAT },
	{ video::texture_format::rgb32f,  VK_FORMAT_R32G32B32_SFLOAT },
	{ video::texture_format::rgba32f, VK_FORMAT_R32G32B32A32_SFLOAT },

	{ video::texture_format::d16,  VK_FORMAT_D16_UNORM },
	{ video::texture_format::d32f, VK_FORMAT_D32_SFLOAT },
	{ video::texture_format::s8,   VK_FORMAT_S8_UINT },

	{ video::texture_format::d16_s8,  VK_FORMAT_D16_UNORM_S8_UINT },
	{ video::texture_format::d32f_s8, VK_FORMAT_D32_SFLOAT_S8_UINT },
	{ video::texture_format::d24_s8,  VK_FORMAT_D24_UNORM_S8_UINT },

	{ video::texture_format::bc1,           VK_FORMAT_BC1_RGB_UNORM_BLOCK },
	{ video::texture_format::bc1_srgb,      VK_FORMAT_BC1_RGB_SRGB_BLOCK },
	{ video::texture_format::bc1_srgb_rgba, VK_FORMAT_BC1_RGBA_SRGB_BLOCK },

	{ video::texture_format::bc4,        VK_FORMAT_BC4_UNORM_BLOCK },
	{ video::texture_format::bc5_signed, VK_FORMAT_BC5_SNORM_BLOCK },
	{ video::texture_format::bc6,        VK_FORMAT_BC6H_UFLOAT_BLOCK },
	{ video::texture_format::bc7_srgb,   VK_FORMAT_BC7_SRGB_BLOCK }
};
