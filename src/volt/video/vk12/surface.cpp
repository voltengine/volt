...
surface::surface(std::shared_ptr<video::device> &&device, std::shared_ptr<os::window> &&window)
	: video::surface(std::move(device), std::move(window)) {
...
// std::vector<const std::shared_ptr<video::texture>> &surface::get_frames() {
