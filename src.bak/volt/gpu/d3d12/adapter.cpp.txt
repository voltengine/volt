...
// adapter::adapter(std::shared_ptr<gpu::instance> &&instance, IDXGIAdapter1 *d3d_adapter)
// 		: gpu::adapter(std::move(instance)), d3d_adapter(d3d_adapter) {
...
// 	return std::shared_ptr<gpu::device>(
