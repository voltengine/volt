...
VOLT_API const std::unordered_map<std::string, std::set<std::string>> &component_names();

VOLT_API const std::unordered_map<std::string, std::set<std::string>> &system_names();
...
VOLT_API extern std::unordered_map<std::type_index, std::string> component_type_index_to_name;
VOLT_API extern std::unordered_map<std::type_index, std::string> system_type_index_to_name;

VOLT_API extern std::unordered_map<std::string, size_t> component_name_to_index;
VOLT_API extern std::unordered_map<std::type_index, size_t>
		component_type_index_to_index; // Not necessary, kept just for lookup speed

VOLT_API extern std::unordered_map<std::string, std::function<base_component_storage *
		()>> component_name_to_storage_constructor;
VOLT_API extern std::unordered_map<std::string, std::function<system *
		()>> system_name_to_constructor;

VOLT_API extern std::unordered_map<std::string, std::
		unique_ptr<system>> system_instances;

// Module stuff
VOLT_API extern std::unordered_map<std::string, std::set<
